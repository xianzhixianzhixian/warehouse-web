...
CREATE TABLE `supplier` (
  ...
  `receiver` varchar(50) NOT NULL DEFAULT '' COMMENT '对接人',
  `receiver_phone` varchar(70) NOT NULL DEFAULT '' COMMENT '对接人联系方式',
  `responser` varchar(50) NOT NULL DEFAULT '' COMMENT '负责人',

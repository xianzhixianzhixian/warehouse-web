			...
			<div class="login_internal">
				<form class="form-horizontal">
					...
					<div class="col-sm-offset-1 col-sm-4" style="margin-top: 10px;">
						<button type="button" class="btn btn-primary btn-block" style="font-size:16px;font-weight: 700;" onclick="addGoodsIntoWarehouse();">出库</button>
					</div>
	...
	<script type="text/javascript">
		...
		function addGoodsIntoWarehouse(){
				...
				|| innum=='' || innum==null)
			{
				...
				innum=Number($("#savedNum").val().trim())-innum;
				$.ajax({
